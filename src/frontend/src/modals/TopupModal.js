...
const docsLink =
  "https://github.com/dfinity/portal/blob/master/docs/developer-docs/integrations/t-ecdsa/t-ecdsa-how-it-works.md";
    ...
    <Modal isOpen={isOpen} onClose={onClose} isCentered size="lg">
      ...
      <ModalContent>
        ...
        <ModalBody>
          <Flex flexDir="column">
            <Text mb="12px">
              Signing transactions requires payment in cycles. Topup by sending
              ICP to the account bellow.
            </Text>
            <Box
              mb="12px"
              p="8px"
